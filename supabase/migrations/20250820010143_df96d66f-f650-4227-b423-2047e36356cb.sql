-- Enhanced Performance Tracking Schema (Fixed)
...
CREATE POLICY "Admin/manager can insert genre correlations" 
ON public.genre_correlation_matrix FOR INSERT 
WITH CHECK (is_vendor_manager());

CREATE POLICY "Admin/manager can update genre correlations" 
ON public.genre_correlation_matrix FOR UPDATE 
USING (is_vendor_manager()) 
WITH CHECK (is_vendor_manager());

CREATE POLICY "Admin/manager can delete genre correlations" 
ON public.genre_correlation_matrix FOR DELETE 
USING (is_vendor_manager());
