...
function groupSimilarGenres(spotifyGenres: string[]): string[] {
  ...
  const genreCategories = {
    ...
    'techno': ['techno', 'hard techno', 'detroit techno'],
    'minimal': ['minimal', 'minimal techno', 'minimal house'],
    'house': ['house', 'deep house', 'tribal house'],
    'progressive house': ['progressive house', 'prog house'],
    'bass house': ['bass house', 'bassline house'],
    'big room': ['big room', 'big room house', 'bigroom'],
    ...
    'trap': ['electronic trap', 'edm trap', 'future trap'],
    ...
    'hip-hop': ['hip hop', 'rap', 'trap music', 'drill', 'boom bap', 'conscious hip hop', 'gangsta rap', 'old school hip hop', 'mumble rap'],
